...
CREATE TABLE `class_attribute` (
	...
	FOREIGN KEY (`type_id`) REFERENCES `class_class` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE `class_operation` (
	...
	`static` BOOLEAN NOT NULL,
	FOREIGN KEY (`class_id`) REFERENCES `class_class` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (`returnType_id`) REFERENCES `class_class` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
);
